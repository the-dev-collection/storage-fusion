...
echo "  oc get applications -n argocd | grep maas"
echo "  oc describe application maas-operators -n argocd"
echo ""
...
# Get ArgoCD URL
ARGOCD_ROUTE=$(oc get route argocd-server -n argocd -o jsonpath='{.spec.host}' 2>/dev/null || echo "N/A")
